...
class Rook extends Piece {
	...
	Rook(final Model model, final Colour colour, final Square currentSquare) {
		pieceId = colour == Colour.WHITE ? 3 : 9;
	...
	boolean isMoveValid(final HorizontalMove horizontalMove) {
		...
		if (isRightTurn && isPathClear)
			return true;
		Logger.print(this, "Check results of " + colour + " rook horizontal move:" + "\nisRightTurn:" + isRightTurn
	...
	boolean isMoveValid(final VerticalMove verticalMove) {
		...
		if (isRightTurn && isPathClear)
			return true;
		Logger.print(this, "Check results of " + colour + " rook vertical move:" + "\nisRightTurn:" + isRightTurn
				+ "\nisPathClear: " + isPathClear);
		return false;
	}
